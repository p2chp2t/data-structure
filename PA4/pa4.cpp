...
/*
    ...
    Description:
        ...
        So the total capacity of a hash table will be k??^r.
        ...
        And you don?셳 need to consider an overflow of the overflow bucket. 
...
/*
    ...
    Description:
        ...
        Then, we multiply this value by the size of a hash table and take the 詮굊or of the result.
        So h_1 will be denoted as

        h_1 (k) = floor(2^r (kA mod 1)).

        For simplicity, let?셲 use A =0.1.
        ...
        You don?셳 need to consider an insertion when the table is full, a deletion of a key which does not exist, and multiple insertions of the same key.
        And also you don?셳 need to consider the case when the hash function cannot find an available slot.
...
/*
    ...
    Description:
        ...
        If there exist n strongly connected component, then 
            ...
            2) print the strongly connected components in an ascending lexicographical order of it?셲 smallest label of nodes. 
...
/*
    ...
    Description:
        Implement a function that finds the Minimum-cost Spanning Tree (MST) of the given weighted undirected graph using Prim?셲 algorithm.
    ...
    Input: A sequence of commands
        ...
        - ('MST','A'): find MST using the Prim?셲 algorithm which starts with node A.
    Output:
